        ...
        {ServiceData.map((item) => (
          <SwiperSlide key={item.title}>
            <Link href={`/vorur/[title]?title=${item.title}`}>
              <div className="bg-gray-100 bg-opacity-70 hover:bg-opacity-100 flex flex-col mb-20 border-2 border-solid border-red-500 hover:border-green-600 hover:shadow-2xl group relative shadow-lg rounded-xl h-[400px] lg:h-[400px] w-full overflow-hidden cursor-pointer">
